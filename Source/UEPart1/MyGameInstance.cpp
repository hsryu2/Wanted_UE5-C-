...
void UMyGameInstance::Init()
{
	...
	UE_LOG(LogTemp, Log, TEXT("중복 없는 학생 이름의 수: %d"), AllUniqueName.Num());
	// 학생 데이터를 TMap으로 변환.
	Algo::Transform(
		StudentsData,
		StudentsMap,
	...
	UE_LOG(LogTemp, Log, TEXT("이름에 따른 학생 멀티 맵의 데이터 수: %d"), StudentsMapByName.Num());
